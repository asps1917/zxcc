...
try 3 'int x; int main() { x=3; foo(); return x;} int foo() {int x; x=4; return 0;}'
...
try 1 'int main() { char x; x=1; char y; y=2; return x; }'
try 2 'int main() { char x; x=1; char y; y=2; return y; }'
